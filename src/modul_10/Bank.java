...
class Bank {
    public static void main(String args []){
        ...
        try {
                                                  ...
                                                  if (pin==1234)//cek pin
                                                      do{
                                                          ...
                                                          switch (choice){
                                                              ...
                                                              case 2 : strl = JOptionPane.showInputDialog(null,"Masukan jumlah penyetoran : "); //menabung
                                                                        ...
                                                                        JOptionPane.showMessageDialog(null, "Terimakasih telah menggunakan ATM BRI, ambil kartu ATM Anda.");
                                                                              System.exit(0);
                                                              case 3 : strl = JOptionPane.showInputDialog(null,"Masukan jumlah penarikan : "); // pengambilan
            ...
            JOptionPane.showMessageDialog(null, "Kesalahan !\nPastikan kode yang anda masukkan berformat tidak benar ! \nPROGRAM KELUAR ! \nTerimakasih","ERROR",0);
        }
    }
